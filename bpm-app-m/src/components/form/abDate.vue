<template>
	<datetime v-model="val" v-bind:start-date="startDate" v-bind:end-date="endDate" format="YYYY-MM-DD HH:mm"></datetime>
</template>
...
export default {
  	props: ['value',"min","max","minformat","maxformat","cal","caltype"],
  	data :function () {
	    return {
	    	val:this.value,
	    	startDate:"",
